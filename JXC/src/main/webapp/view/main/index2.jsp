...
<div class="navbar navbar-default" id="navbar">
		...
		<div class="navbar-container" id="navbar-container">
			<div class="navbar-header pull-left">
				<a href="view/main/index.jsp" class="navbar-brand"> <small> <i
						class="icon-leaf"></i> 智慧企业进销存管理系统
				</small>
				</a>
				<!-- /.brand -->
			</div>
				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <img class="nav-user-photo"
							...
							class="user-info"> <small>欢迎光临,${adminLogin.employeeAccount }</small>
						...
						<ul
							...
							<li>
								<!-- admin/modifyPassword.actipn?employeeId=${adminLogin.employeeId} -->
								<!-- view/main/modifyPassword.jsp -->
								<a href="admin/goModifyPassword.action"  target="mainframe"> 
									<i class="icon-user"></i> 
									修改密码
								</a>
							</li>
							...
							<li><a href="admin/signOut.action"> <i class="icon-off"></i> 退出
							</a></li>
						</ul></li>
				</ul>
				<!-- /.ace-nav -->
		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					<li class="active"><a
						href="view/main/main.jsp" target="mainframe">
			    ...
			    <li><a href="javascript:void(0)" target="mainframe"
						...
						<ul class="submenu">
                            ...
                            <li><a href="admin/adminPaging.action" target="mainframe"> <i
									class="icon-double-angle-right"></i> 管理员管理
							</a></li>
							<li><a href="role/roleSelect.action" target="mainframe"> <i
									class="icon-double-angle-right"></i> 角色管理
							</a></li>
							<li><a href="menu/menuSelect.action" target="mainframe"> <i
									class="icon-double-angle-right"></i> 菜单管理
							</a></li>
							<li><a href="employee/employeeSelect.action" target="mainframe"> <i
									class="icon-double-angle-right"></i> 员工管理
							</a></li>
							<li><a href="datadictionary/datadictionarySelect.action" target="mainframe"> <i
				...
				<li><a href="javascript:void(0)" target="mainframe"
						...
						<ul class="submenu">
							<li><a href="goods/goodsSelect.action" target="mainframe"> <i
									class="icon-double-angle-right"></i> 商品管理
							</a></li>
                            <li><a href="supplier/supplierSelect.action" target="mainframe"> <i
									class="icon-double-angle-right"></i> 供应商管理
							</a></li>
							<!-- view/system/purchaseorder/purchaseorder_list.jsp-->
							<li><a href="goods/purchaseOrderByGoods.action" target="mainframe"> <i
									class="icon-double-angle-right"></i> 采购订单管理
							</a></li>
							<li><a href="purchaseorder/jxcPurchaseorderSelect.action" target="mainframe"> <i
									class="icon-double-angle-right"></i> 订单审核管理
							</a></li>
							<!-- <li><a href="view/system/userinfo/userinfo_list.html" target="mainframe"> <i
									class="icon-double-angle-right"></i> 采购退货管理
							</a></li> -->
						</ul>
				</li>
				<li><a href="javascript:void(0)" target="mainframe"
						...
						<ul class="submenu">
							<li><a href="purchaseorder/jxcPurchaseorderStockSelect.action" target="mainframe"> <i
									class="icon-double-angle-right"></i> 库存管理
							</a></li>
							<!-- <li><a href="view/system/userinfo/userinfo_list.html" target="mainframe"> <i
									class="icon-double-angle-right"></i> 采购审核管理
							</a></li>
							<li><a href="view/system/userinfo/userinfo_list.html" target="mainframe"> <i
									class="icon-double-angle-right"></i> 采购退货审核
							</a></li> -->
							<!-- <li><a href="view/system/userinfo/userinfo_list.html" target="mainframe"> <i
									class="icon-double-angle-right"></i> 销售审核管理
							</a></li>
							<li><a href="view/system/userinfo/userinfo_list.html" target="mainframe"> <i
									class="icon-double-angle-right"></i> 销售退货审核
							</a></li> -->
				...
				<li><a href="javascript:void(0)" target="mainframe"
						...
						<ul class="submenu">
							<li><a href="customer/customerSelect.action" target="mainframe"> <i
									class="icon-double-angle-right"></i> 客户管理
							</a></li>
                            <li><a href="view/system/userinfo/userinfo_list.html" target="mainframe"> <i
									class="icon-double-angle-right"></i> 销售订单管理
							</a></li>
							<li><a href="view/system/userinfo/userinfo_list.html" target="mainframe"> <i
									class="icon-double-angle-right"></i> 销售退货管理
							</a></li>
						</ul>
				</li>
				<!-- <li><a href="javascript:void(0)" target="mainframe"
						class="dropdown-toggle"> <i class="icon-desktop"></i> <span
							class="menu-text"> 商品管理 </span> <b class="arrow icon-angle-down"></b>
					</a>
				...
				<li><a href="javascript:void(0)" target="mainframe"
						class="dropdown-toggle"> <i class="icon-desktop"></i> <span
							class="menu-text"> 仓库管理 </span> <b class="arrow icon-angle-down"></b>
					</a>

						<ul class="submenu">
							
                            <li><a href="warehouse/warehouseSelect.action" target="mainframe"> <i
									class="icon-double-angle-right"></i> 仓库管理
							</a></li>
						</ul>
				</li>
				<li><a href="javascript:void(0)" target="mainframe"
				...
				<li><a href="javascript:void(0)" target="mainframe"
						class="dropdown-toggle"> <i class="icon-desktop"></i> <span
							class="menu-text"> 统计管理 </span> <b class="arrow icon-angle-down"></b>
					</a>

						<ul class="submenu">
							
                            <li><a href="view/system/userinfo/userinfo_list.html" target="mainframe"> <i
									class="icon-double-angle-right"></i> 管理员报表
							</a></li>
							<li><a href="view/system/userinfo/userinfo_list.html" target="mainframe"> <i
									class="icon-double-angle-right"></i> 客户报表
							</a></li>
							<li><a href="view/system/userinfo/userinfo_list.html" target="mainframe"> <i
									class="icon-double-angle-right"></i> 员工报表
							</a></li>
						</ul>
				</li>
				<li><a href="javascript:void(0)" target="mainframe"
						class="dropdown-toggle"> <i class="icon-desktop"></i> <span
							class="menu-text"> 系统介绍 </span> <b class="arrow icon-angle-down"></b>
					</a>
						<ul class="submenu">
                            <li><a href="view/system/introduce/introduce.jsp" target="mainframe"> <i
									class="icon-double-angle-right"></i> 系统介绍 
							</a></li>
						</ul>
				</li>
				</ul>
			...
			<div class="main-content" id="mains">
				<iframe id="mainframe" name="mainframe" src="view/main/main.jsp"
