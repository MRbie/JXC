	...
	<div class="main-container" id="main-container">
		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<!-- 动态加载对应的权限 -->
				<c:forEach items="${mlogin }" var="menu">
					<c:if test="${menu.menuUpid == 0 }">	
				    <li><a href="javascript:void(0)" target="mainframe"
							...
							<ul class="submenu">
								<c:forEach items="${mlogin }" var="menu2">
								<c:if test="${menu.menuId == menu2.menuUpid }">
	                            <li><a href="${menu2.menuPath }" target="mainframe"> <i
										class="icon-double-angle-right"></i> ${menu2.menuName }
								</a></li>
								</c:if>
								</c:forEach>
							</ul>
