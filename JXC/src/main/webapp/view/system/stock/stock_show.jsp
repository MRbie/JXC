...
<form action="purchaseorder/jxcPurchaseorderStockSelect.action" class="form-inline" method="post">
	  ...
	  <div class="row">
		...
		<div class="col-md-4">
			<nav aria-label="Page navigation">
			  <ul class="pagination">
				<!-- 首页点击功能 -->
				<li><a href="${basePath}purchaseorder/jxcPurchaseorderStockSelect.action?pn=1">首页</a></li>
				<!-- 上一页点击功能 -->
				<c:if test="${pageInfo.hasPreviousPage }">
					 <li>
					  <a href="${basePath}purchaseorder/jxcPurchaseorderStockSelect.action?pn=${pageInfo.pageNum-1}" aria-label="Previous">
				...
				<c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
					...
					<c:if test="${page_Num != pageInfo.pageNum }">
						<li>
							<a href="${basePath}purchaseorder/jxcPurchaseorderStockSelect.action?pn=${ page_Num}">
								${ page_Num}
							</a>
						</li>
					</c:if>
				...
				<c:if test="${pageInfo.hasNextPage }">
					<li>
					  <a href="${basePath}purchaseorder/jxcPurchaseorderStockSelect.action?pn=${pageInfo.pageNum+1}" aria-label="Next">
				...
				<!-- 末页点击功能 -->
				<li>
					<a href="${basePath}purchaseorder/jxcPurchaseorderStockSelect.action?pn=${pageInfo.pages}">
						末页
					</a>
				</li>
			  </ul>
