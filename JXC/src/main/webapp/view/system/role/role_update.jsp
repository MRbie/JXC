...
<form action="role/roleUpdate.action" id="f1" class="form-horizontal" method="post">
		<input type="hidden" name="roleId" value="${resultSingleRole.roleId }"/>	
		...
		<div class="row">
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" required minlength="2" value="${resultSingleRole.roleName }" name="roleName" class="form-control" placeholder="请输入角色名称" />
					</div>
				</div>
			</div>
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" required minlength="6" value="${resultSingleRole.roleCode }" name="roleCode" class="form-control" placeholder="请输入角色编码" />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" required minlength="6" value="${resultSingleRole.roleUpdater }" name="roleUpdater" class="form-control" placeholder="请输入角色更新人" />
					</div>
				</div>
			</div>
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" value="${resultSingleRole.roleUpdatetime }" class="form-control" name="roleUpdatetime" class="Wdate" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" placeholder="请输入角色更新时间" />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" value="${resultSingleRole.roleExtend }" name="roleExtend" class="form-control" placeholder="请输入角色扩展" />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9">
						<textarea class="form-control" name="roleDesc" rows="3" placeholder="请输入角色描述信息">${resultSingleRole.roleDesc }</textarea>
					</div>
				</div>
			</div>
