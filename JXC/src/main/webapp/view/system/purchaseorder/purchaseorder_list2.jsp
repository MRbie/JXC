...
<script type="text/javascript">
	...
	$(function(){
	    ...
	    /* $("#jxcPurchaseorder").click(function(){
	     ...
	     $("#purchaseorderChoose").click(function(){
	    	 //alert("测试");
	    	 $.ajax({
	             type : "POST",//post类型请求。
	             ...
	             success : function(resultGoods) {
	            	 ...
	            	 for(var i=0;i<json.length;i++){
	                     ...
	                     '<td>' + '<a href="purchaseorder/choosePurchaseorder.action?goodsId='+goodsId+'" class="btn btn-success">选中商品<a>' + '</td>' +
	                     '</tr>';
	            	 }
...
<form action="purchaseorder/jxcPurchaseorderInsert.action" id="f1" method="get" class="form-horizontal">
	...
	<h5 class="page-header alert-info" style="margin: 0px; padding: 10px; margin-bottom: 10px;">
		选择商品：&nbsp;&nbsp;
		<input type="button" id="purchaseorderChoose" value="选择商品" style="margin-right:40px;" data-toggle="modal" data-target="#myModal" class="btn btn-danger"/>
	...
	<table id="tab" class="table table-striped table-hover table-bordered">
		...
		<tr>
			<td>
				<input type="Checkbox" id="choiceBox" name="box" value="${resultJxcGoods.goodsId }"/>
			</td>
			<td>
			...
			<td>
				<input type="text" size="8" id="orderNumber" class="form-control" name="orderNumber"/>
			</td>
		</tr>
		</c:forEach>
	</table>
	...
	<table id="tab" class="table table-striped table-hover table-bordered">
		...
		<tr>
			<td>
				${resultPurchaseorder.orderId }
			</td>
			<td>
				${resultPurchaseorder.warehouseName }
			</td>
			<td>${resultPurchaseorder.employeeName }</td>
			<td>${resultPurchaseorder.supplierName }</td>
...
<!-- <script type="text/javascript">
	var choiceGoodsSuccess= $("choiceGoodsSuccess");
	alert(choiceGoodsSuccess);
	if(choiceGoodsSuccess != null && choiceGoodsSuccess!=""){
		alert($("choiceGoodsSuccess"));
	}
