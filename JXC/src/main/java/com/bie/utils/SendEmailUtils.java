...
//	        pros.put("mail.smtp.ssl.socketFactory", sf);
     ...
     * @param from 谁发送的邮件
     */
    public static void baseSendMailMessage(String subject,String text,String from){
    	Map<String,String> map= new HashMap<String,String>();
        SendEmailUtils mail = new SendEmailUtils("1748741328@qq.com","rbvzdbgbjhvpgahj");
        ...
        try {
			...
			mail.initMessage();
			//单人发送邮件模式
			mail.setRecipient("1748741328@qq.com");
...
//	    mail.setRecipients(sb);
        ...
        mail.setSubject("我是邮箱标题呀");
        mail.setText("我是邮箱内容呀");
        mail.setDate(new Date());
        mail.setFrom("我是发件人的名字呀");
//	    mail.setMultipart("D:你你你.txt");
//	    mail.setContent("谢谢合作123", "text/html; charset=UTF-8");
