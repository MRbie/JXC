...
public class AddressUtils {
    ...
    public void getAddressByIp() throws Exception {  
        ...
        address += city + "/";  
        address += county;  */
        String address = "国家:"+ country + " , 地区:" +  area 
        		+ " , 省份" + region + ", 城市"+city  + ", 区/县" + county +
        		", 互联网服务提供商" + isp;
        System.out.println(address);  
    }  
	
    
    //封装的工具类,获取到外网的地址和外网ip
    public static String getOuterNetIp(){
        ...
        //判断一下是否获取到值
        if(json_result != null && !"".equals(json_result) && !"null".equals(json_result)){
        	JSONObject json = JSONObject.fromObject(json_result);  
            System.out.println("json数据： " + json);  
            String country = JSONObject.fromObject(json.get("data")).get("country").toString();  
            String region = JSONObject.fromObject(json.get("data")).get("region").toString();  
            ...
            address += city + "/";  
            address += county;*/
            /*String address = "国家:"+ country + " , 省份" + region 
            		+ ", 城市:"+city  +", 互联网服务提供商" + isp;*/
            String address = country + "/" + region 
            		+ "/"+city  +"/" + isp +"运营商";
            return address;
        }
		return null;
